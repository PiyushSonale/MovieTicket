...
import com.app.exception.ShowNotFoundException;
...
public class ShowController {
	 ...
	 */
	@PostMapping("/add/{theatreId}/{screenId}")
	public ResponseEntity<Show> addShow(@RequestBody Show show, @PathVariable Integer theatreId,
