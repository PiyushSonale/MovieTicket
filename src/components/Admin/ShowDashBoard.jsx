...
class ShowDashBoard extends Component {
    ...
    componentDidMount(){
        ...
        axios.get(`http://localhost:8080/screens/viewScreen/${this.state.op}`).then((response)=>{
    ...
    addmovie=(showId)=>{
        console.log("in add show to movie method")
        window.location.replace(`/Admin/AddShowtoMovie/${showId}`)
                        ...
                        <tbody>
                            {
                                ...
                                <tr key={show.showId}>
                                    ...
                                    <td> <button className="btn btn-danger" onClick={()=>this.addmovie(show.showId)}>Addmovie</button></td>
